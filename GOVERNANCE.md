...
This project exists to produce rigorous, impartial, publicly available analytical
work on Iranian regime architecture and transition dynamics. All governance decisions
must be evaluated against a single test: does this decision serve that mission or
does it serve something else?

Factional alignment, political advocacy, or institutional capture by any government,
opposition group, or diaspora organization is incompatible with the mission and
constitutes grounds for leadership review.
...
**Default:** All content in this repository is licensed under CC BY-SA 4.0.
